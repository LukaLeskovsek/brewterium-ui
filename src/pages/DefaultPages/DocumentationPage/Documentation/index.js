...
+
+
├─ cleanui-admin-template-react-starter-kit/    .. starter kit
...
└─ documentation.html                           .. link to template documentation`}
          ...
          <hr />
          <p>
            This template uses font Nunito Sans, loaded from{' '}
            <a
          ...
          <pre
          >{`<link href="//fonts.googleapis.com/css?family=Nunito+Sans:400,400i,700,700i" rel="stylesheet">`}</pre>
          <br />
          <h4>6. Changelog</h4>
          <hr />
          <Collapse>
            <Panel header="Version 1.1.2" key="4">
              - New Dashboard (Gamma)
              <br />- Dependencies Update
            </Panel>
            <Panel header="Version 1.1.1" key="3">
              - React-app-rewire-less version fix
              <br />- Starter-kit updates
            </Panel>
            <Panel header="Version 1.1.0" key="2">
              - New Dashboards (Alpha&Crypto)
              <br />- New Layout Type (Horizontal Top Menu)
              <br />- Architecture improvements
